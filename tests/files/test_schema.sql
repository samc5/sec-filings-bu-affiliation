...
CREATE TABLE IF NOT EXISTS Alumni (
    ...
    relationship_to_bu VARCHAR(50) CHECK (relationship_to_bu IN (
        'student', 'professor', 'admin', 'advisor', 'board_of_trustees', 'donor', 'researcher', 'business', 'transitive'
    ))
);
...
CREATE TABLE IF NOT EXISTS Alumni_Relationships (
    ...
    relationship_to_bu VARCHAR(50) CHECK (relationship_to_bu IN (
        'student', 'professor', 'admin', 'board_of_trustees', 'donor', 'researcher', 'vendor'
    )),
